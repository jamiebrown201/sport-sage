...
import { FootballIcon, TennisIcon, DartsIcon, CricketIcon } from '@/components/icons';
...
export function EventCard({ event, onPress, compact = false }: EventCardProps): React.ReactElement {
